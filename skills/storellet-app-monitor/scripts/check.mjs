#!/usr/bin/env node
// Storellet App Store Monitor — Daily rating & review check
...
const IOS_APP_ID = '936066838';
const ANDROID_PACKAGE = 'com.crozz.storellet';
const SLACK_CHANNEL_NAME = 'automation-testing';
const HISTORY_DIR = '/root/clawd/skills/storellet-app-monitor/data';
...
function formatSlackMessage(date, ios, iosReviews, android, lastEntry) {
  const lines = [];
  lines.push(`📱 Storellet App Store 每日報告（${date}）`);
  lines.push('');
